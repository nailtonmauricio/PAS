...
$sql = "SELECT id, title, color, start, end, descricao FROM events WHERE usuario_id='" . $_SESSION['id'] . "'";
                ...
                <div class="form">
                    <form name="formAgenda" class="form-horizontal" method="POST" action="<?php echo pg; ?>/process/edit/edit_events">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <textarea class="form-control" name="descricao" id="descricao" rows="10" style="resize: none;"></textarea>
                            </div>
                        </div>
                        <div class="form-group">
            ...
            <div class="modal-body">
                <form name="formAgenda" class="form-horizontal" method="POST" action="<?php echo pg; ?>/process/reg/reg_events">
                    <div class="form-group">
                        <label for="title" class="col-sm-2 control-label">Titulo</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="title" id="title" placeholder="Titulo do Evento" value="<?php
                            if (isset($_SESSION['dados']['title'])) {
                                echo $_SESSION['dados']['title'];
                            }
                            ?>"/>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <label for="start" class="col-sm-2 control-label">Inicio</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="start" id="start" onKeyPress="DataHora(event, this)" value="<?php
                    ...
                    <div class="form-group">
                        <label for="end" class="col-sm-2 control-label">Fim</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="end" id="end" onKeyPress="DataHora(event, this)" value="<?php
                            if (isset($_SESSION['dados']['end'])) {
                                echo $_SESSION['dados']['end'];
                            }
                            ?>"/>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="descricao" class="col-sm-2 control-label">Descrição</label>
                        <div class="col-sm-10">
                            <textarea class="form-control" name="descricao" id="descricao" placeholder="Descreva o evento cadastrado em parágrafo único." rows="10" style="resize: none;" value="<?php
